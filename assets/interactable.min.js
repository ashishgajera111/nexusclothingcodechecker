    ...
    (T4SThemeSP.Tooltip = (function () {
      ...
      (T4SThemeSP.ProductAjax = (function () {
        var t = { loading: "is--loading" },
          ...
          o = i ? "cart_data" : "cart_data,mini_cart",
          a = i
            ? "cart_data"
            : `cart_data,mini_cart,${window.QuickOrderListID}`,
          s =
            "cart" != g
              ? "product" == g
                ? a
          ...
          l = T4Sconfigs.enableAjaxATC,
          c = T4Sconfigs.enableAjaxCart,
          u = T4Sroutes.cart_add_url + ".js",
          p = T4Sroutes.cart_change_url + ".js",
          m = T4Sconfigs.disATCerror,
          f = s.split(","),
          h = "change.required keyup.required",
          v = "is--field-emty is--animated t4s-ani-shake";
        function T(e = "json") {
          return {
            method: "POST",
            headers: {
        ...
        function y(e = !1) {
          e && !m && T4SThemeSP.Notices(e);
        }
        function S(e, t, n) {
          var i = e.closest("[data-cart-item]"),
            o = e.closest("[data-cart-wrapper]"),
            a = i.find(".t4s-cart-ld__bar"),
            l = a.find(".t4s-cart-spinner");
          ...
          (c.headers["X-Requested-With"] = "XMLHttpRequest"),
            ...
            fetch(`${p}`, c)
              ...
              .then((e) => {
                if (e.status)
                  return (
                    y(e.description), void r.trigger("cart:updated", ["error"])
                  );
                b(e.sections);
              })
              .catch((e) => {
        ...
        function x(i) {
          var o,
            a = i.find("[data-field-required]"),
            s = !!i.hasClass("has--properties") && a.length > 0,
            c = !1;
                  ...
                  a.each(function () {
                    ...
                    n.hasClass("is--type-checkbox")
                      ? n.find("input[name]").is(":checked") ||
                        (n.addClass(v), (c = !0))
                      : 0 == t.val().length && (n.addClass(v), (c = !0));
                  })),
                c)
              )
                return (
                  ...
                  void a.off(h).on(h, function (t) {
                    let n = e(this),
                      i = n.closest("[data-item-property-field]");
                    i.hasClass("is--type-radio") ||
                    i.hasClass("is--type-checkbox")
                      ? i.find("input[name]").is(":checked") && i.removeClass(v)
                      : n.val().length > 0 && i.removeClass(v);
                  })
                );
              if (!l) return;
              a.off(h),
    ...
    (T4SThemeSP.initLoadMore = function () {
      ...
      (T4SThemeSP.Cart = (function () {
        var t = "[data-cart-items]",
          ...
          u = "data-t4s-percent",
          m = "[data-replace-content]",
          f = !0,
          h = !0,
          T = "disable" == T4Sconfigs.cartType,
          S = "cart" != g ? T4Sconfigs.afterActionATC : "4",
          ...
          C = window.QuickOrderListID,
          P = "cart" != g ? w : `cart_data,${x}`,
          k = 19041994,
          I = !1,
          D = {},
          A = window.T4Sroutes.cart_url;
        function M() {
          e("[data-cart-count]").html(e("#t4s-mini_cart").data("ccount")),
            ...
            T ||
              ...
              r.on("update:mini_cart:wishlist", z),
        ...
        function R(l, f = !1) {
          ...
          if (
            (0 !=
              (h = (h = h.split("[t4s_split1]")[1]).split("[t4s_split2]"))[0] &&
              !T4SThemeSP.isATCSuccess) ||
            "cart" != g
          ) {
            !T4SThemeSP.isATCSuccess && f && (T4SThemeSP.isATCSuccess = f),
              _.html(y.find(t).html()),
              P.html(y.find(n).html()),
              k.attr(u, y.find(i).attr(u)),
              D.replaceWith(y.find(o).wrap()),
              A.attr("style", y.find(a).attr("style")),
              M.html(y.find(s).html()),
              b.html(w.find(m).html());
              console.log(y.find(i).attr(u));

            var kgCartShippingBars = document.querySelectorAll(".kg-cart-thes-ship-bar");
            if (kgCartShippingBars) {
                if (y.find(i).attr(u) >= 100) {
                    kgCartShippingBars.forEach(function (kgCartShippingBar) {
                        kgCartShippingBar.style.display = "none";
                    });
                } else {
                    kgCartShippingBars.forEach(function (kgCartShippingBar) {
                        kgCartShippingBar.style.display = "";
                    });
                }
            }
            
            var E = parseFloat(h[0]);
            e("[data-cart-count]").html(E),
              e("[data-cart-ttcount]").html(
                E < 2 ? p.item_cart[E] : p.item_cart[2]
              ),
              e("[data-cart-tt-price]").html(h[1]),
              "1" == h[2]
                ? (e(
              ...
              0 == h[0]
                ...
                : (c.removeClass("t4s-cart-count-0"), I && (W(), (I = !1))),
              document.dispatchEvent(
            ...
            "1" == S ||
              ...
              ("3" == S
                ...
                : (document.location.href =
                    "5" == S ? T4SThemeSP.root_url + "checkout" : A));
        }
        function N(t) {
          var n,
        ...
        function U() {
          ...
          n[0] &&
            ...
            n.on("click", '[data-action="estimate-shipping"]', B.bind(n[0])));
        }
        function B(t) {
          ...
          s.addClass(b.loading),
            ...
            fetch(
              A + "/shipping_rates.json?" + e.param({ shipping_address: a }),
              { credentials: "same-origin", method: "GET" }
            ).then(function (t) {
              document.dispatchEvent(new CustomEvent("theme:loading:end")),
                s.removeClass(b.loading),
        ...
        function H() {
          ...
          t > 0 && f
            ? (T4SThemeSP.CanvasConfetti(), (f = !1), (h = !1))
            : e(i).length > 0 && h
            ? (T4SThemeSP.CanvasConfetti(), (h = !1))
            : 0 == t && ((h = !1), (f = !0));
        }
        function W() {
          let t = e(`[${l}]`);
          ...
          T4SThemeSP.getToFetchSection(null, "text", i).then((n) => {
            ...
            D.flickityt4s && D.flickityt4s.destroy(),
              t.html(e(n).html()),
              d.trigger("currency:update"),
              T4SThemeSP.Tooltip();
            let i = t.find(".flickityt4s")[0];
            i &&
              ((D.flickityt4s = new T4SThemeSP.Carousel(i)),
              setTimeout(function () {
        ...
        return {
          ...
          init: function () {
            !(function () {
              if ("cart" == g)
                return (
                  $(), F(), L(), U(), T4SThemeSP.agreeForm(), H(), void W()
                );
              IsDesignMode
                ? M()
                : T ||
                    ...
                    (t) => {
                      "NVT_94" != t &&
                        T4SThemeSP.Helpers.promiseStylesheet(
                          ...
                          e("#t4s-mini_cart").html(e(t).html()), M();
                        });
                    }
                  );
            })(),
