!(function (t) {
  ...
  var wt = {
      select: function (t, e) {
        ...
        t.find(at).flickityt4s(mt, a), t.find(at).flickityt4s(ht);
      },
      deselect: function (t) {
        t.find(at).flickityt4s(pt);
      },
    },
    Ct = "t4s-sp-section-mb-nav",
    Tt = "t4s-sp-section-mb-cat",
    kt = T4Sconfigs.theme;
  T4Sconfigs.isPageIndex &&
    ...
    d.on(ot, function (a) {
      ...
      if (
        ...
        h.initLoadMore(),
        m.trigger("t4s:hideTooltip"),
        l.hasClass(b) || l.hasClass(u))
      ) {
        var Y = l.find(et);
        Y.length > 0 &&
          (Y.each(function (t) {
            this["flickityt4s" + t] = new h.Carousel(this);
          }),
          h.resizeEventT4(),
          T4SThemeSP.goToID());
      }
      ...
      if (l.hasClass(G) || l.hasClass(L)) {
        ...
        M.addClass("initProducts__enabled"),
          l.hasClass(G) && t(".t4s-sticky-atc").remove(),
          t(".drift-bounding-box.drift-open").remove();
        var j = M.find("[data-main-media].flickityt4s");
        j.length > 0 && (j[0].flickityt4s = new h.Carousel(j[0])),
          new h.Product(M),
          h.ProductZoom(),
          h.PopupMFP(),
          h.Tabs.Default(),
      ...
      } else l.hasClass(Z) ? h.Footer() : l.hasClass(W) && (T4SThemeSP._initBundlePrs(), T4SThemeSP.initGroupsProduct(), T4SThemeSP.ProductAjax.init());
      if (
        (l.hasClass(f) || l.hasClass(y)
          ...
          ? h.instagram()
          : (l.is(N) || l.is(I)) &&
            (l.find(".t4s-announcement-bar").length > 0
        ...
        h.Drawer.close();
        var st = at.split("[t4splitlz]"),
          nt = st[2].split("[t4splitlz2]");
        A.html(st[1]),
        ...
        if (lt) {
          var rt = window.innerWidth,
            ...
            ct = document.querySelectorAll(
              "#shopify-section-" + n + " .t4s-products"
            )[0],
            mt = "is--listview on--list-",
            ht = mt;
          rt < 768 && "list_t4s" == dt[0]
            ? (mt += "mobile")
            : rt < 1025 && rt > 767 && "list_t4s" == dt[1]
            ? (mt += "tablet")
            : rt > 1024 && "list_t4s" == dt[2] && (mt += "desktop"),
    ...
    d.on(lt, function (s) {
      ...
      if ((e(lt, l), (o = i(l) || o), l.hasClass(b))) {
        ...
        r.length > 0 &&
          setTimeout(function () {
            r[0].flickityt4s = new h.Carousel(r[0]);
          }, 300);
      }
      o == B || o == A
        ...
        : o == F || o == H
        ? (m.trigger("modalt4s:closed"),
          setTimeout(function () {
            var e = l.find(">template").html(),
              a = o == F ? "main-qv" : "main-qs",
              s = o == F ? "t4s-opening-qv" : "t4s-opening-qs";
              ...
              o == F
                ? function () {
                    ...
                    s.hasClass("flickityt4s") &&
                      ...
                      (s[0].flickityt4s = new h.Carousel(s[0])),
                      h.PopupMFP(),
                      window.Shopify &&
                ...
                : function () {
                    var e = t(
                      ".t4s-product-quick-shop:not(.initProducts__enabled)"
                    );
    ...
    d.on(rt, function (a) {
      ...
      e(rt, o),
        ...
        s == B || s == A || s == j || s == Q
          ...
          : o.hasClass(gt) && t(`.${S} .t4s-h-cat`).removeClass(Y);
    }),
    d.on(dt, function (a) {
      var s = a.detail.sectionId,
        o = a.detail.blockId,
      ...
      if (
        ...
        l.is(":visible")
          ? t("#b_" + o + ":not(.t4s-active)").trigger("click")
          : t("#t44_" + o + ":not(.t4s-active)").trigger("click");
      else if (n.hasClass(f) || n.hasClass(v))
        t("#b_" + o + ":not(.t4s-active)").trigger("click");
      else if (n.hasClass(y))
        r.width() > 1024
          ? t("#b_" + o + ":not(.t4s-active)").trigger("click")
          : t("#b2_" + o + ":not(.t4s-active)").trigger("click");
      else if (n.hasClass(X))
        t('[data-pin-popup][data-bid="t4s_' + s + o + '"]').trigger("click");
      else if (n.hasClass("t4s-section-mega__menu")) {
        ...
        h =
          t(".t4s-push-menu-btn[data-toggle-trigger]").attr(
            "data-toggle-class"
          ) || "active";
        t(".t4s-push-menu-btn[data-toggle-trigger]:not(." + h + ")").trigger(
          "click"
        );
        ...
        s == B || s == A
          ...
          : s == J &&
            ...
            t.magnificPopupT4s.instance.isOpen &&
              !(
                l.is("#t4s-popup__age") ||
                l.is("#t4s-popup__exit") ||
                l.is("#t4s-popup__newsletter")
              ) &&
              t.magnificPopupT4s.close(),
    ...
    d.on(ct, function (a) {
      ...
      if (
        ...
        t("#b_" + o + ".t4s-active").trigger("click");
      else if (n.hasClass(y))
        r.width() > 1024
          ? t("#b_" + o + ".t4s-active").trigger("click")
          : t("#b2_" + o + ".t4s-active").trigger("click");
      else if (n.hasClass(X))
        t('[data-pin-popup][data-bid="t4s_' + s + o + '"]').trigger("click");
      else if (n.hasClass("t4s-section-mega__menu")) {
        var d = t('[data-blockid="' + o + '"]'),
        ...
        t(".t4s-push-menu-btn[data-toggle-trigger]." + h).trigger("click");
      } else if (n.hasClass(S)) {
        ...
        s == B || s == A
          ...
          : s == J &&
            ((l = t(`[data-block="${o}"]`)).is("#t4s-popup__age") ||
            l.is("#t4s-popup__exit") ||
            l.is("#t4s-popup__newsletter")
              ? t.magnificPopupT4s.instance.isOpen || l.trigger("close.popup")
