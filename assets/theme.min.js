                ...
                A.countdown(S.format("YYYY-MM-DD " + l), { elapse: !0 }).on(
                  ...
                  function (e) {
                    if (e.elapsed) n.hide();
                      ...
                      var kgDeliveryhours = 24 * e.offset.totalDays + e.offset.hours;
                      var kgDeliveryminutes = e.offset.minutes > 0 ? e.offset.minutes : 0;
                      var kgDeliveryseconds = e.offset.seconds > 0 ? e.offset.seconds : 0;
                      var i = kgDeliveryhours + " hours " + kgDeliveryminutes + " minutes " + kgDeliveryseconds + " seconds";
                      A.html(i).show();
                      // console.log(e.strftime(t.trim(A.html().replace("[totalHours]", i))));
          ...
          if (this.PrOptionsSize) {
            ...
            s.$formSelectorId.on(
              ...
              function (d) {
                d.preventDefault();
                var l = t(this);
                l.closest("[data-swatch-option]").find("[data-current-value]").removeClass("kg-variant-is--not-selected");
                if (
                  (l
                    .addClass("is--selected")
                    .siblings()
